...
import AssetUnitForm from './AssetUnitForm'
...
describe('Components:AssetUnitForm', () => {
  beforeEach((done) => {
    done()
  })

  it('Should render AssetUnitForm component', () => {
  ...
  it('Should display form fields correctly', () => {
    ...
    expect(wrapper.find(Field).length).to.equal(8)
  })
